...
const EditRestaurantForm = () => {
    ...
    const [restaurantData, setRestaurantData] = useState({name: "", email: "", phone: "", address: "", description: "", food_type: ""})
        ...
        <div className="container py-5" style={{ maxWidth: "500px" }}>
            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <button onClick={()=>editRestaurant(restaurant_id, restaurantData)} className="btn btn-primary w-100 mb-3">Edit restaurant</button>
