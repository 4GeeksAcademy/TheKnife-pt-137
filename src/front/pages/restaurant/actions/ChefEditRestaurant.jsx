...
const ChefEditRestaurant = () => {
    ...
    const { getSingleRestaurant, chefEditRestaurant } = useRestaurant()
    ...
    return (
        <div className="restaurant_form d-flex flex-column align-items-center gap-3">
            ...
            <button onClick={()=>chefEditRestaurant(restaurant_id, restaurantData)} className="btn btn-primary">Edit restaurant</button>
